...
<a href="http://localhost/book/public/register" class="bk_bottom_tips bk_important">没有帐号? 去注册</a>
@endsection
...
@section('my-js')
    ...
    <script>
      ...
      $('.bk_validate_code').click(function(){
        $(this).attr('src', 'http://localhost/book1/public/service/validate_code/create?random=' + Math.random());
      });
