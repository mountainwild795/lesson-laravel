...
@section('content')
  ...
  <form action="http://localhost/book/public/order_commit" id="order_commit" method="post">
    {{ csrf_field() }}
...
<script type="text/javascript">
  ...
  function _toCharge() {
    ...
    // location.href = 'http://localhost/book/public/order_commit/' + product_ids_arr;// 如果是GET使用提交地址
    // location.href = 'http://localhost/book/public/order_pay?product_ids=' + product_ids_arr;
    // location.href = 'http://localhost/book/public/order_commit?product_ids=' + product_ids_arr + '&is_wx=' + is_wx;
  ...
  function _onDelete() {
    ...
    $.ajax({
      type: "GET",
      url: 'http://localhost/book/public/service/cart/delete',
      dataType: 'json',
      cache: false,
