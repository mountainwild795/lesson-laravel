...
<div class="weui_cells weui_cells_form" style="display: none;">
  ...
  <div class="weui_cell weui_vcode">
      ...
      <div class="weui_cell_ft">
          <img src="http://localhost/book/public/service/validate_code/create" class="bk_validate_code"/>
      </div>
  </div>
</div>
...
<a href="http://localhost/book/public/login" class="bk_bottom_tips bk_important">已有帐号? 去登录</a>
@endsection
...
<script>
    ...
    $('.bk_validate_code').click(function(){
      $(this).attr('src', 'http://localhost/book/public/service/validate_code/create?random=' + Math.random());
    })
  </script>
  ...
  function onRegisterClick() {
    ...
    $('input:radio[name=register_type]').each(function(index, el) {
      if($(this).attr('checked') == 'checked') {
        ...
        $.ajax({
          type: "POST",
          url: 'http://localhost/book/public/service/register',
          dataType: 'json',
          cache: false,
